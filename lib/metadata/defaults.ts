...
export const defaultColumns: Rec<Header[]> = {
    "stock_br": [
        ...
        {group: "Cotação", keys: ["yahoo_quote.latest", "derived.yahoo_chart.1mo_chart", "derived.yahoo_chart.1y_chart",
                "derived.yahoo_chart.5y_chart"]},
