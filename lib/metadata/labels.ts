...
const keyLabels: Labels = {
    ...
    "derived.yahoo_chart.1mo_chart": {short: "1M", long: "Último Mês"},
    "derived.yahoo_chart.1y_chart": {short: "1A", long: "Último Ano"},
    "derived.yahoo_chart.5y_chart": {short: "5A", long: "Últimos 5 Anos"},
